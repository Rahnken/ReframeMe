...
export const buttonStyles =
  "rounded-md p-3 hover:bg-brandPrimary-200 hover:text-slate-800 bg-brandPrimary-600 text-slate-200 font-bold";
export const invertedButtonStyles =
  "rounded-md p-3 hover:bg-brandSecondary-200 hover:text-slate-800 bg-brandSecondary-600 text-slate-200 font-bold";
